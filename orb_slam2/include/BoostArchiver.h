...
namespace boost{
    ...
    inline void save( Archive& ar,
                      const Eigen::Array<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>& M,
                      const unsigned int /* file_version */)
    {
      typename Eigen::Array<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>::Index rows = M.rows();
      typename Eigen::Array<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>::Index cols = M.cols();
    ...
    inline void load( Archive& ar,
                      ...
                      const unsigned int /* file_version */)
    {
      typename Eigen::Array<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>::Index rows, cols;
    ...
    inline void load( Archive& ar,
                      Eigen::Array<_Scalar, Eigen::Dynamic, _Cols, _Options, _MaxRows, _MaxCols>& M,
                      const unsigned int /* file_version */)
    {
      typename Eigen::Array<_Scalar, Eigen::Dynamic, _Cols, _Options, _MaxRows, _MaxCols>::Index rows, cols;
    ...
    inline void load( Archive& ar,
                      Eigen::Array<_Scalar, _Rows, Eigen::Dynamic, _Options, _MaxRows, _MaxCols>& M,
                      const unsigned int /* file_version */)
    {
      typename Eigen::Array<_Scalar, _Rows, Eigen::Dynamic, _Options, _MaxRows, _MaxCols>::Index rows, cols;
    ...
    inline void load( Archive& ar,
                      Eigen::Array<_Scalar, Eigen::Dynamic, Eigen::Dynamic, _Options, _MaxRows, _MaxCols>& M,
                      const unsigned int /* file_version */)
    {
      typename Eigen::Array<_Scalar, Eigen::Dynamic, Eigen::Dynamic, _Options, _MaxRows, _MaxCols>::Index rows, cols;
